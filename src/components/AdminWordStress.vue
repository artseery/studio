<template>
  <div class="admin-words">
    ...
    <div v-if="Object.keys(savedWords).length" class="admin-words-list">
      ...
      <div v-for="wordObject in savedWords" class="admin-words-list__item">
        <div class="admin-words-list__item-delete" @click="deleteWord(wordObject._id)">
        ...
        <div class="admin-words-buttons admin-words-buttons__list">
          <button
              ...
              :class="[
              {'admin-words-buttons__item--empty': /\s/.test(char)},
              {'admin-words-buttons__item--stressed': wordObject.stress.includes(index)}
              ]"
          >
            <span>{{ char }}</span>
          </button>
